...
--PROCEDURE PARA LISTAR OS UTILIZADORES COM UMA DETERMINADA PROFISSÃO.
CREATE PROCEDURE SP_LIST_USERS_BY_JOB
@JOB_NAME VARCHAR(75)
AS
BEGIN
    SELECT USER_JOB_NAME, USER_ID, USER_FIRST_NAME + ' ' + USER_LAST_NAME AS USER_FULL_NAME, USER_EMAIL, USER_PHONENUMBER, USER_PROFILE_PICTURE_PATH, USER_BIRTHDATE, USER_GENDER_NAME, COUNTRY_NAME, USER_ADRESS, USER_ACADEMIC_LEVEL_NAME, USER_LEVEL_NAME
